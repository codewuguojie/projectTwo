<template>
    <div class="order">
        ...
        <div class="box" v-if="!ispay || !isLogictics || !isorderDetail">
            ...
            <!--全部订单列表-->
            <div class="orderlist" v-if="nowindex==0 && !outLine" v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="10">
                <div class="list" v-for="list in orderList">
                    ...
                    <div class="three">
                        <span class="listmoney"><b class="total">订单总额：</b><b class="totalnum">{{'￥'+list.orderPrice}}</b></span>
                    </div>
                    <div class="four">
            ...
            <!--立即支付订单列表-->
            <div class="orderlist" v-if="nowindex==1 && !outLine" v-infinite-scroll="loadMoreOther" infinite-scroll-disabled="loadingOther" infinite-scroll-distance="10">
                <div class="list" v-for="list in orderList">
                    <div class="one">
                        <div class="left">订单号：&nbsp;{{list.orderNo }}</div>
                        <div class="right" :style="{color:color[list.orderStatus]}">{{orderstatus[list.orderStatus]}}</div>
            ...
            <!--待发货订单列表-->
            <div class="orderlist" v-if="nowindex==2 && !outLine" v-infinite-scroll="loadMoreOther" infinite-scroll-disabled="loadingOther" infinite-scroll-distance="10">
                <div class="list" v-for="list in orderList">
                    <div class="one">
                        <div class="left">订单号：&nbsp;{{list.orderNo }}</div>
                        <div class="right" :style="{color:color[list.orderStatus]}">{{orderstatus[list.orderStatus]}}</div>
            ...
            <!--待收货订单列表-->
            <div class="orderlist" v-if="nowindex==3 && !outLine" v-infinite-scroll="loadMoreOther" infinite-scroll-disabled="loadingOther" infinite-scroll-distance="10">
                <div class="list" v-for="list in orderList">
                    <div class="one">
                        <div class="left">订单号：&nbsp;{{list.orderNo }}</div>
                        <div class="right" :style="{color:color[list.orderStatus]}">{{orderstatus[list.orderStatus]}}</div>
            ...
            <!--已完成订单列表-->
            <div class="orderlist" v-if="nowindex==4 && !outLine" v-infinite-scroll="loadMoreOther" infinite-scroll-disabled="loadingOther" infinite-scroll-distance="10">
                <div class="list" v-for="list in orderList">
                    <div class="one">
                        <div class="left">订单号：&nbsp;{{list.orderNo }}</div>
                        <div class="right" :style="{color:color[list.orderStatus]}">{{orderstatus[list.orderStatus]}}</div>
    ...
    export default {
        ...
        methods:{
            ...
            uploadData(){
                ...
                getResult('get',`/order/v1/order/list/${this.myindex}?pageIndex=${this.pageIndex}&pageSize=${this.pageSize}`)
                    .then(data=>{
                            ...
                            if(data.data.list.length == parseInt(this.pageSize) || data.data.list.length < parseInt(this.pageSize)){
                                ...
                                if(this.orderList !=null && this.orderList.length>0){
                                    this.orderList.forEach((value,index,arr)=>{
                                        ...
                                        console.log(Date.parse(value.payExpireTime.replace(/-/g,'/')))
        ...
        mounted(){
            ...
            */
            ...
            // getResult('get',`/order/v1/order/list/${this.myindex}`)
            //     .then(data=>{
            //         console.log(data.data)
            //         data.data.list.forEach((value)=>{
            //             value.countDown1 = ''
