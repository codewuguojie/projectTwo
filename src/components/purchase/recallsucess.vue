    ...
    <div class="result">
        <div class="head">
            <div class="topTitle">
                ...
                <span class="text">转入结果</span>
            </div>
        </div>
        <div class="contents">
            <div class="tips">
                <p class="p4"><img src="./img/recall.png"><p>
                <p class="p1">转入申请已提交，请耐心等待</p>
                <p class="p2">申请转入金额：<b>{{count |toThousands}}REX</b></p>
                <p class="p3"><span @click="goAccount()">确定</span></p>
