...
<script>
    ...
    export default {
        ...
        computed:{
            province(){
                return this.address[this.pIndex].name;//获取省
            },
            city(){
                return this.address[this.pIndex].cityList.length==1?this.address[this.pIndex].cityList[0].areaList:this.address[this.pIndex].cityList;//获取市
            },
            town(){
                return this.address[this.pIndex].cityList.length==1?[]:this.address[this.pIndex].cityList[this.cIndex].areaList;//获取区
            },
            hasTown(){
